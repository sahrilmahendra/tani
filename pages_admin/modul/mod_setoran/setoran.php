    ...
    <div class="col-lg-8">
        <div class="panel panel-green">
            <div class="panel-heading">
				<i class="fa fa-list-alt"></i>&ensp;Laporan Setoran Gabah
            </div>
...
if(isset($_GET['setoran'])){
	...
	$query = mysql_query("SELECT * FROM setoran WHERE tanggal BETWEEN '$awal' AND '$akhir' ORDER BY tanggal ASC") or die(mysql_error());
	...
	<div class="col-lg-4">
		<div class="panel panel-yellow">
			...
			<form action="media.php" method="GET" name="setoran">
				<input type='hidden' value='' name='setoran'>

    ...
    <div class="col-lg-8">
        <div class="panel panel-green">
            <div class="panel-heading">
				<i class="fa fa-list-alt"></i>&ensp;Laporan Pembelian Anda
            </div>
			<div class="panel-body">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
				<?php 
if(isset($_GET['pembelian']) AND isset($_GET['awal']) AND isset($_GET['akhir'])){
	$awal=$_GET['awal'];
	$akhir=$_GET['akhir'];
	if($awal==''){
		$awal=$date;
	...
	$query = mysql_query("SELECT * FROM pembelian WHERE id_user='$user' AND tanggal BETWEEN '$awal' AND '$akhir' ORDER BY tanggal ASC") or die(mysql_error());
...
$nota=$s['no_nota'];
echo "
<form method='post' action='media.php?pembelian=detail&nota=$nota'>
...
if(isset($_GET['pembelian']) AND isset($_POST['detail'])){
...
echo "
	...
	<div class="col-lg-4">
		<div class="panel panel-yellow">
            ...
            <div class="panel-body">
			<form action="media.php" method="GET" name="pembelian">
				<input type='hidden' value='<?php echo $user;?>' name='pembelian'>
